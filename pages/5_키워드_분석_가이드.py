...
<div class="tip-box">
    ...
    "수능 공부법" → 포화지수 100+ (극도로 포화)<br>
    "수능 국어 비문학 시간 분배" → 포화지수 0.2 (블루오션!)<br><br>
...
| 항목 | 데이터 소스 | 설명 |
|------|-----------|------|
| **블로그 발행수** | 네이버 블로그 검색 API | 해당 키워드가 포함된 블로그 글 총 수 |
...
예시: "의대 입시" 키워드 클러스터
- 🏷️ **의대** 클러스터: 의대, 의대 순위, 서울대 의대, 의대 정시
- 🏷️ **약대** 클러스터: 약대편입, 약대 입시, 약대 순위
- 🏷️ **면접** 클러스터: 의대 면접, MMI 면접, 다중미니면접
""")
...
<div class="metric-card">
    ...
    예: "수능" (11월 급등), "여름 다이어트" (5~7월 상승)<br>
...
<div class="tip-box">
    ...
    예: "수능 공부법" vs "수능 준비 방법" → 트렌드가 더 높은 쪽을 메인 키워드로!
</div>
""", unsafe_allow_html=True)
...
| 연령대 | 글쓰기 팁 |
|--------|-----------|
| **13~18세** (중고생) | 친근한 톤, 구체적 방법론, 동기부여 |
| **25~39세** (학부모) | 전문적 + 따뜻한 톤, 자녀 관점 |
| **40~54세** (학부모) | 입시 전략 중심, 비용/효율 강조 |
| **19~24세** (대학생/재수생) | 효율적 전략, 현실적 조언 |
""")
...
<div class="metric-card">
    ...
    예시:<br>
    • 메인: "의대 입시" → "2026 의대 입시 전략 총정리 (현직 입시 전문가)"<br>
    • 메인: "생기부 세특" → "생기부 세특 작성법 5가지 (의대 합격생 실제 사례)"<br><br>
